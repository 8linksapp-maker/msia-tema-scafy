...
import {
    ...
    Wrench, MapPin, LayoutGrid, Building2, Layers,
} from 'lucide-react';
...
// Conteúdo do Site — páginas e seções editáveis
const siteContentItems: NavItem[] = [
    { label: 'Páginas', href: '/admin/paginas', icon: LayoutGrid, section: 'paginas' },
...
// SEO Local — matriz serviço × localidade
const seoLocalItems: NavItem[] = [
    { label: 'Serviços', href: '/admin/servicos', icon: Wrench, section: 'servicos' },
    { label: 'Localidades', href: '/admin/locais', icon: MapPin, section: 'locais' },
    { label: 'Matriz (URLs)', href: '/admin/matriz', icon: Layers, section: 'matriz' },
    { label: 'Dados da empresa', href: '/admin/nap', icon: Building2, section: 'nap' },
];
        ...
        >
            ...
            <nav className="flex-1 overflow-y-auto py-4 px-3" aria-label="Principal">
                ...
                <div className="mb-5" role="group" aria-labelledby="nav-site">
                    <p id="nav-site" className="text-[10px] font-bold text-ink-faint uppercase tracking-widest px-3 mb-1.5">Conteúdo do Site</p>
                ...
                <div className="mb-5" role="group" aria-labelledby="nav-seo-local">
                    <p id="nav-seo-local" className="text-[10px] font-bold text-ink-faint uppercase tracking-widest px-3 mb-1.5">SEO Local</p>
                    {seoLocalItems.map(item => (
                        <NavLink key={item.href} item={item} active={activeSection === item.section} />
                    ))}
                </div>
